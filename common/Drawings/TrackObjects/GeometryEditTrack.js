...
(function(window, undefined) {
    ...
    EditShapeGeometryTrack.prototype.getBounds = function() {
        ...
        bounds_checker.Bounds.min_x = Math.min.apply(Math, arr_p_x) / scaleCoefficient;
        bounds_checker.Bounds.max_x = Math.max.apply(Math, arr_p_x) / scaleCoefficient;
        bounds_checker.Bounds.min_y = Math.min.apply(Math, arr_p_y) / scaleCoefficient;
        bounds_checker.Bounds.max_y = Math.max.apply(Math, arr_p_y) / scaleCoefficient;
