...
$(function () {
    ...
    api.AddDefName('myRange', 'Sheet1!$D$1:$F$4');
    ...
    QUnit.test("SetSort: B1:C4, sort by 'myRange' defined name, headers no, orientation column, should sort by C", function(assert) {
        ...
        ws.GetRange("B1:C4").SetSort("myRange", "xlDescending", null, null, null, null, "xlNo", "xlSortColumns");

        // After sort, columns should be ordered by row 3 values descending
        assert.strictEqual(ws.GetRange("A1").GetValue(), "1");
        assert.strictEqual(ws.GetRange("B1").GetValue(), "4");
        assert.strictEqual(ws.GetRange("C1").GetValue(), "3");

        assert.strictEqual(ws.GetRange("A2").GetValue(), "2");
        assert.strictEqual(ws.GetRange("B2").GetValue(), "3");
        assert.strictEqual(ws.GetRange("C2").GetValue(), "4");

        assert.strictEqual(ws.GetRange("A3").GetValue(), "3");
        assert.strictEqual(ws.GetRange("B3").GetValue(), "2");
        assert.strictEqual(ws.GetRange("C3").GetValue(), "1");

        assert.strictEqual(ws.GetRange("A4").GetValue(), "4");
        assert.strictEqual(ws.GetRange("B4").GetValue(), "1");
        assert.strictEqual(ws.GetRange("C4").GetValue(), "2");
    });
    ...
    QUnit.test("SetSort: A1:C4, sort by C1:A1, headers no, orientation column, should sort by C", function(assert) {
        // Fill A1:C4 with values:
        // 1 4 3
        // 2 3 4
        // 3 2 1
        ...
        // Sort by key range C1:A1 (i.e., sort columns by row 1 descending)
        ws.GetRange("A1:C4").SetSort("C1:A1", "xlDescending", null, null, null, null, "xlNo", "xlSortColumns");

        // After sort, columns should be ordered by row 3 values descending
        assert.strictEqual(ws.GetRange("A1").GetValue(), "2");
        assert.strictEqual(ws.GetRange("B1").GetValue(), "3");
        assert.strictEqual(ws.GetRange("C1").GetValue(), "4");

        assert.strictEqual(ws.GetRange("A2").GetValue(), "1");
        assert.strictEqual(ws.GetRange("B2").GetValue(), "4");
        assert.strictEqual(ws.GetRange("C2").GetValue(), "3");

        assert.strictEqual(ws.GetRange("A3").GetValue(), "4");
        assert.strictEqual(ws.GetRange("B3").GetValue(), "1");
        assert.strictEqual(ws.GetRange("C3").GetValue(), "2");

        assert.strictEqual(ws.GetRange("A4").GetValue(), "3");
        assert.strictEqual(ws.GetRange("B4").GetValue(), "2");
        assert.strictEqual(ws.GetRange("C4").GetValue(), "1");
    });

    QUnit.test("SetSort: B1:C4, sort by C1:A1, headers no, orientation column, should sort by C", function(assert) {
        // Fill A1:C4 with values:
        // 1 4 3
        // 2 3 4
        // 3 2 1
        ...
        // Sort by key range C1:A1 (i.e., sort columns by row 1 descending)
        ws.GetRange("B1:C4").SetSort("C1:A1", "xlDescending", null, null, null, null, "xlNo", "xlSortColumns");
    ...
    QUnit.test("SetSort: B1:C4, sort by 'super' defined name, headers no, orientation column, should sort by C", function(assert) {
        // Fill A1:C4 with values:
        // 1 4 3
        // 2 3 4
        // 3 2 1
        ...
        // Sort by key range C1:A1 (i.e., sort columns by row 1 descending)
        ws.GetRange("B1:C4").SetSort("super", "xlDescending", null, null, null, null, "xlNo", "xlSortColumns");
        ...
        assert.strictEqual(ws.GetRange("A2").GetValue(), "2");
        assert.strictEqual(ws.GetRange("B2").GetValue(), "2");
        assert.strictEqual(ws.GetRange("C2").GetValue(), "1");

        assert.strictEqual(ws.GetRange("A3").GetValue(), "3");
        assert.strictEqual(ws.GetRange("B3").GetValue(), "3");
        assert.strictEqual(ws.GetRange("C3").GetValue(), "4");

        assert.strictEqual(ws.GetRange("A4").GetValue(), "4");
        assert.strictEqual(ws.GetRange("B4").GetValue(), "4");
        assert.strictEqual(ws.GetRange("C4").GetValue(), "3");
    });
